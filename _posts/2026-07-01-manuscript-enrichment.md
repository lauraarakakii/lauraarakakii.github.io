...
## Why Re-Enrich Instead of Rebuild[#why-re-enrich](#why-re-enrich)
...
## The New Columns[#the-new-columns](#the-new-columns)
...
## New Stage: RFC → Patch[#rfc-stage](#rfc-stage)
...
## New Stage: Revision Cycles[#revision-cycles](#revision-cycles)
...
## New Stage: Mentorship / Visibility Signal[#mentorship-signal](#mentorship-signal)
...
## New Stage: Patch Complexity[#patch-complexity](#patch-complexity)
...
## A Data-Quality Note on Trailers[#trailers-note](#trailers-note)
...
## Staying Backward-Compatible[#backward-compatible](#backward-compatible)
