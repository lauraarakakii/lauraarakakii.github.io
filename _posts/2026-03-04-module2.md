...
description: Notes and lessons learned while installing the kw tool
date: 2026-03-04 15:25:00 +/-TTTT
categories: [Kernel Development]
tags: [kernel, linux, debian, kw, arm64, boot, vm]
author: <author_id> # for single entry
---

## Introduction

Following the MAC0470/5856 – Linux Kernel Development course at IME-USP, this is the second module in my series of notes. In the [previous post](https://lauraarakakii.github.io/posts/module1/), I set up a safe virtual machine environment using QEMU and libvirt on my Ubuntu 24.04 host.
...
- Proper PATH configuration is critical after installing tools from source, especially if you're using Ubuntu as your main distro.. When in doubt, using the full path (`$KW_DIR/kw`) is a reliable workaround.
