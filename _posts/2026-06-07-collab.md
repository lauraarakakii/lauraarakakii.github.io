...
The contribution produces three output artifacts:

### Duplication Dataset (`output/analysis/duplicate_messages.csv` and `output/analysis/dataset/duplicate_messages.parquet`)

This dataset contains only duplicated patches. Each entry includes the following columns:

- **message_id** – unique identifier for the message
- **body_sha1** – SHA-1 hash of the message body
- **date** – timestamp of the message
- **number_of_replicas** – count of duplicate occurrences
- **lists_present** – lists in which the duplicates appear
